 ...
 * \brief Fonction qui permet d'ajuster la direction et la vitesse de rotation des moteurs 
 * selon le rapport A/B.
 ...
 */
void Roues::ajustementRoues(const uint8_t rapportABRoueDroite, const uint8_t rapportABRoueGauche,
const Direction direction){
    OCR1A = 0xFF * (rapportABRoueDroite / 100.0); 
    // pour générer des signaux PWM selon rapport A/B (Port D5).
    OCR1B = 0xFF * (rapportABRoueGauche / 100.0); 
    ...
    case AVANT:
    {
        ...
        // PORT D2 = Direction roue gauche; PORT D3 = Direction roue droite.                          
        // 0 pour avancer et 1 pour reculer.
        break;
    }
